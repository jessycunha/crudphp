            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Visualize, edite ou exclua os produtos do estoque.</p>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Adicione novas categorias para classificar os produtos.</p>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Adicione novos fornecedores para o seu negócio.</p>
                        <a href="inserir_fornecedor.php" class="btn btn-primary">Cadastrar</a>
                    </div>
                </div>
            </div>
        </div>
